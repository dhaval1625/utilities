                ...
                <div className="panel sm:w-[480px] m-6 max-w-lg w-full">
                    ...
                    <ul className="flex justify-center gap-2 sm:gap-5 mb-5">
                        <li>
                            <button
                                type="button"
                                className="btn flex shrink-0 gap-1 sm:gap-2 text-black shadow-none bg-white-dark/30 dark:border-[#253b5c] dark:hover:bg-[#1b2e4b] dark:bg-transparent dark:text-white hover:bg-white "
                            >
